...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1f1778c3-7b1c-4408-a3ac-36beee3c1070
```

> `1f1778c3-7b1c-4408-a3ac-36beee3c1070` is the password of the certificate, you can change it to any password you want.
